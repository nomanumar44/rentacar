                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="{{ $message->embed(public_path('images/logo.jpeg')) }}" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="64" />
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                Hello !<br></br>
                                                Thank you for signing up for . We're really happy to have you! Click the link below to login to your account:
                                            </div>
